	...
	return (
		<View style={styles.locationPicker}>
			...
			<View style={styles.actions}>
				<Button title="Get User Location" color={Colors.primary} onPress={getLocationHandler} style={styles.button} />
				<Button title="Pick on Map" color={Colors.primary} onPress={pickOnMapHandler} style={styles.button} />
			</View>
		</View>
	);
}
